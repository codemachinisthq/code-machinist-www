...
export interface ButtonProps
  ...
  asChild?: boolean
  // base-ui compatibility shims (render/nativeButton accepted but unused by our impl)
  render?: React.ReactElement
  nativeButton?: boolean
}

const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, render: _render, nativeButton: _nb, ...props }, ref) => {
